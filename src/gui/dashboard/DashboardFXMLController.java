...
//    private Button btnLogout = new Button("Déconnexion");
    ...
    @FXML
    private ImageView iconCoach1;
    @FXML
    private Button btnAjoutCoachings;
...
//        mainWindow.setScene(newScene);
    ...
    @FXML
    private void ajouterCoaching(ActionEvent event) throws IOException {
          clientComboBox.getSelectionModel().clearSelection();
    ...
    @FXML
    private void ListCoaching(ActionEvent event) throws IOException {
          clientComboBox.getSelectionModel().clearSelection();
        Parent root = FXMLLoader.load(getClass().getResource("../AffichCoaching/market.fxml"));
